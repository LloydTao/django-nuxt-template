<template>
  <section class="py-12 px-4">
    <div class="max-w-3xl mx-auto">
      <h2 class="text-4xl text-center mb-4 font-heading">
        Frequently Asked Questions
      </h2>
      <div class="p-4 mb-2 border-b">
        <button class="flex w-full text-left">
          <span class="flex-grow font-semibold"
            >How does Dunder Mifflin paper differ from other products?</span
          ><img class="w-12" src="placeholders/icons/angle-bottom.svg" alt="" />
        </button>
        <p class="mt-1">
          Paper produced with love, devotion, passion - is not the same paper.
          Our supplies are extra strong, and you’re going to need the paper-tear
          up-master to destroy just one sheet. It’s also suited for every
          available printer.
        </p>
      </div>
      <div class="p-4 mb-2 border-b">
        <button class="flex w-full text-left">
          <span class="flex-grow font-semibold"
            >Why choose Dunder Mifflin instead of some huge paper
            producer?</span
          ><img class="w-12" src="placeholders/icons/angle-bottom.svg" alt="" />
        </button>
        <p class="hidden mt-1">
      ...
      <div class="p-4 mb-2 border-b">
        <button class="flex w-full text-left">
          <span class="flex-grow font-semibold"
            >When I will receive the products?</span
          ><img class="w-12" src="placeholders/icons/angle-bottom.svg" alt="" />
        </button>
        <p class="hidden mt-1">
          If you buy one of our business plans, you will receive the supplies
          every first Monday of the month. However, you can also purchase paper
          separately. Our employees will make sure that you will receive the
          products in the next business days.
        </p>
      </div>
      <div class="p-4 mb-2 border-b">
        <button class="flex w-full text-left">
          <span class="flex-grow font-semibold"
            >How long does it take to finalize the deal?</span
          ><img class="w-12" src="placeholders/icons/angle-bottom.svg" alt="" />
        </button>
        <p class="hidden mt-1">
