  ...
  <section class="py-12 px-4">
    <div class="flex flex-wrap -mx-8">
      <div class="lg:w-1/2 px-8 mt-6 lg:mt-0 order-2 lg:order-none">
        <h2 class="text-4xl mb-2 font-heading">
        ...
        <div class="flex mb-6">
          <ul class="flex list-reset">
            <li>
              <a class="block py-2 px-3 mr-2 bg-gray-200 rounded" href="#"
                >Product Details</a
              >
            </li>
            <li>
              <a class="block py-2 px-3 mr-2 hover:bg-gray-200 rounded" href="#"
                >Reviews</a
              >
            </li>
            <li>
        ...
        <button
          class="inline-block py-4 px-8 leading-none text-white bg-indigo-500 hover:bg-indigo-600 rounded"
        >
          Buy Now!
        </button>
      </div>
